...
static int __init lm363x_regulator_init(void)
{
	pr_info("lm363x_regulator_init\n");
	return platform_driver_register(&lm363x_regulator_driver);
}
subsys_initcall(lm363x_regulator_init);

static void __exit lm363x_regulator_exit(void)
{
	platform_driver_unregister(&lm363x_regulator_driver);
}
module_exit(lm363x_regulator_exit);
